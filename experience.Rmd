...
- **Columbia University Mailman School of Public Health** [New York, NY]{style="float:right"}  
  ...
  - Related Courses: Probability, Biostatistical Methods I, Principles of Epidemiology, Statistical Inference, Statistical Computing with SAS, New drug development, Introduction to Clinical Trials, Clinical Trial Methodlogy, Survival Analysis, Data Science, Relational Databases and SQL Programming
...
- **Factors Associated with Fatality After Suicide Attempt Using Logistic Regression and Poisson Regression** [Suzhou, China]{style="float:right"}    
...
- **Developing an Interactive Epitranscriptome Website to Query Single-base Resolution Sequencing Data** [Suzhou, China]{style="float:right"}    
